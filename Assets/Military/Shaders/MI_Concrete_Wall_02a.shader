Shader "Unreal/MI_Concrete_Wall_02a"
{
    Properties
    {
		...
		Material_Texture2D_0( "L1 Normal", 2D ) = "white" {}
		Material_Texture2D_1( "L2 Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Blend Mask", 2D ) = "white" {}
		Material_Texture2D_3( "Detail Normal", 2D ) = "white" {}
		Material_Texture2D_4( "L1 Albedo ", 2D ) = "white" {}
		Material_Texture2D_5( "L1 RMA", 2D ) = "white" {}
		Material_Texture2D_6( "TX_Dust_01a_M", 2D ) = "white" {}
		Material_Texture2D_7( "L2 Albedo ", 2D ) = "white" {}
		Material_Texture2D_8( "Detail Base Color", 2D ) = "white" {}
		Material_Texture2D_9( "L2 RMA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Concrete_Wall_02a.hlsl"
        VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
        {
            VertexDescription description = (VertexDescription)0;
            float3 WPO = PrepareAndGetWPO( IN.VertexColor, IN.AbsoluteWorldSpacePosition, IN.ObjectSpaceNormal, float4(IN.WorldSpaceTangent,1), IN.uv0, IN.uv0 );WPO = TransformWorldToObjectDir( WPO, false );
