...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(2.000000,2.000000,2.000000,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,71853819665588303167488.000000,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local17 = saturate(Local14.r);
