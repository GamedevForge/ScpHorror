...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.881232,1.000000,0.969803);//(Unknown)
	Material.PreshaderBuffer[2] = float4(2.563703,4.027118,0.000000,0.000000);//(Unknown)
