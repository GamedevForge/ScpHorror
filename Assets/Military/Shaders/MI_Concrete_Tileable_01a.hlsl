...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.500000,1.000000,2.696111);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.697739,1.468825,-0.468825,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(1.600000,1.600000,1.600000,0.504762);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.493153,0.000000,0.000000,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,2342618309221767933965907523534848.000000,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Normal = Local28;
	...
	MaterialFloat3 Local29 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[3].xyz,Material.PreshaderBuffer[2].w);
	MaterialFloat Local30 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 2);
	MaterialFloat4 Local31 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local32 = MaterialStoreTexSample(Parameters, Local31, 2);
	MaterialFloat3 Local33 = (Local31.rgb * Material.PreshaderBuffer[4].xyz);
	MaterialFloat Local34 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 2);
	MaterialFloat4 Local35 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias));
	MaterialFloat Local36 = MaterialStoreTexSample(Parameters, Local35, 2);
	MaterialFloat3 Local37 = (Local35.rgb * Material.PreshaderBuffer[5].xyz);
	MaterialFloat3 Local38 = lerp(Local33,Local37,Local27.r.r);
	MaterialFloat Local39 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local40 = Texture2DSampleBias(Material_Texture2D_5,samplerMaterial_Texture2D_5,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local41 = MaterialStoreTexSample(Parameters, Local40, 0);
	MaterialFloat Local42 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 0);
	MaterialFloat4 Local43 = Texture2DSampleBias(Material_Texture2D_6,samplerMaterial_Texture2D_6,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias);
	MaterialFloat Local44 = MaterialStoreTexSample(Parameters, Local43, 0);
	MaterialFloat Local45 = lerp(Local40.g,Local43.g,Local27.r.r);
	MaterialFloat Local46 = (Local40.b * 0.50000000);
	MaterialFloat Local47 = (Local43.b * 0.50000000);
	MaterialFloat Local48 = lerp(Local46,Local47,Local27.r.r);
	MaterialFloat Local49 = PositiveClampedPow(Local40.r,Material.PreshaderBuffer[5].w);
	MaterialFloat Local50 = (Local49 * Material.PreshaderBuffer[6].x);
	MaterialFloat Local51 = saturate(Local50);
	MaterialFloat Local52 = saturate(Local43.r);
	MaterialFloat Local53 = lerp(Local51,Local52,Local27.r.r);
	MaterialFloat Local54 = lerp(Local40.b,Local43.b,Local27.r.r);
	...
	PixelMaterialInputs.Specular = Local48;
	PixelMaterialInputs.Roughness = Local53;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local28;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local54;
