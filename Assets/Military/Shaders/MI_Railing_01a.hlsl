...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.697917,0.608539,0.585232,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.139583,0.121708,0.117046,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,0.922596,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 2);
	MaterialFloat4 Local10 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local11 = MaterialStoreTexSample(Parameters, Local10, 2);
	MaterialFloat3 Local12 = (Local10.rgb * Material.PreshaderBuffer[2].xyz);
	MaterialFloat2 Local13 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[2].w));
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local13), 5);
	MaterialFloat4 Local15 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local13),View.MaterialTextureMipBias);
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 5);
	MaterialFloat3 Local17 = lerp(Material.PreshaderBuffer[4].xyz,Material.PreshaderBuffer[3].xyz,Local15.r);
	MaterialFloat Local18 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local19 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local20 = MaterialStoreTexSample(Parameters, Local19, 0);
	MaterialFloat Local21 = (1.00000000 - Local19.b);
	MaterialFloat Local22 = (Local21 * Material.PreshaderBuffer[4].w);
	MaterialFloat Local23 = PositiveClampedPow(WorldNormalCopy.b,Material.PreshaderBuffer[5].x);
	MaterialFloat Local24 = (Local23 * Material.PreshaderBuffer[5].y);
	MaterialFloat Local25 = (Local15.r * Material.PreshaderBuffer[5].z);
	MaterialFloat Local26 = (Local24 - Local25);
	MaterialFloat Local27 = (Local22 + Local26);
	MaterialFloat Local28 = saturate(Local27);
	MaterialFloat3 Local29 = lerp(Local12,Local17,Local28);
	MaterialFloat Local30 = (Local19.b * 0.50000000);
	MaterialFloat Local31 = saturate(Local19.r);
	MaterialFloat Local32 = lerp(Local31,0.89999998,Local28);

	PixelMaterialInputs.EmissiveColor = Local8;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local29;
	PixelMaterialInputs.Metallic = Local19.g;
	PixelMaterialInputs.Specular = Local30;
	PixelMaterialInputs.Roughness = Local32;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local7;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local19.b;
