...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.301961,0.301961,0.309804,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.250000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[1].w;
