...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.000000,0.938949);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.450710,0.000000,0.000000,0.000000);//(Unknown)
