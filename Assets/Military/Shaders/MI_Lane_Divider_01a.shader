Shader "Unreal/MI_Lane_Divider_01a"
{
    Properties
    {
		...
		Material_Texture2D_3( "Albedo Multi Tint Mask ", 2D ) = "white" {}
		Material_Texture2D_4( "RMA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Lane_Divider_01a.hlsl"
