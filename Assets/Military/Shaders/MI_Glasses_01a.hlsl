...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.666667,0.633715,0.553620,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.295874,1.000000,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,-260.046875,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local13 = (Local10.rgb * Material.PreshaderBuffer[3].xyz);
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local15 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 0);
	MaterialFloat3 Local17 = lerp(Local12,Local13,Local15.r);
	MaterialFloat3 Local18 = (Local10.rgb * Material.PreshaderBuffer[4].xyz);
	MaterialFloat3 Local19 = lerp(Local17,Local18,Local15.g);
	MaterialFloat3 Local20 = (Local10.rgb * Material.PreshaderBuffer[5].xyz);
	MaterialFloat3 Local21 = lerp(Local19,Local20,Local15.b);
	MaterialFloat Local22 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local23 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local24 = MaterialStoreTexSample(Parameters, Local23, 0);
	MaterialFloat Local25 = (Local23.b * 0.50000000);
	MaterialFloat Local26 = saturate(Local23.r);

	PixelMaterialInputs.EmissiveColor = Local8;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local21;
	PixelMaterialInputs.Metallic = Local23.g;
	PixelMaterialInputs.Specular = Local25;
	PixelMaterialInputs.Roughness = Local26;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local7;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local23.b;
