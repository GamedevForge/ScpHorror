...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(1.000000,0.389823,0.219236,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,-536.000000,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local22 = saturate(Local19.r);
	...
	PixelMaterialInputs.Roughness = Local22;
