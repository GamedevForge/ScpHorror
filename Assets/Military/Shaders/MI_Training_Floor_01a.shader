Shader "Unreal/MI_Training_Floor_01a"
{
    Properties
    {
		...
		Material_Texture2D_1( "TX_Grime_01a_ALB", 2D ) = "white" {}
		Material_Texture2D_2( "L1 Albedo ", 2D ) = "white" {}
		Material_Texture2D_3( "L1 RMA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Training_Floor_01a.hlsl"
