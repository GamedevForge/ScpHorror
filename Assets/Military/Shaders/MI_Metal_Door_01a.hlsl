...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.822917,0.797201,0.797201,1.001091);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.692164,0.809524,0.019048,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,71853526931612524085248.000000,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local13 = (Material.PreshaderBuffer[3].xyz * Local12);
	...
	MaterialFloat Local21 = (Local19.b * 0.50000000);
	MaterialFloat Local22 = PositiveClampedPow(Local19.r,Material.PreshaderBuffer[3].w);
	MaterialFloat Local23 = (Local22 * Material.PreshaderBuffer[4].x);
	MaterialFloat Local24 = lerp(Material.PreshaderBuffer[4].z,Material.PreshaderBuffer[4].y,Local23);
