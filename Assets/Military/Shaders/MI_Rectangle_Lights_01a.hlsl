...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,1.000000,0.712864,0.332601);//(Unknown)
	Material.PreshaderBuffer[2] = float4(2.001550,2.536680,0.000000,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,34463616868404872738490870044557312.000000,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local20 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local21 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local22 = MaterialStoreTexSample(Parameters, Local21, 0);
	MaterialFloat Local23 = (Local21.b * 0.50000000);
	MaterialFloat Local24 = saturate(Local21.r);

	PixelMaterialInputs.EmissiveColor = Local16;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local19;
	PixelMaterialInputs.Metallic = Local21.g;
	PixelMaterialInputs.Specular = Local23;
	PixelMaterialInputs.Roughness = Local24;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local7;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local21.b;
