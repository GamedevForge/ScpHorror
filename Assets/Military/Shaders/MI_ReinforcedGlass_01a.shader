Shader "Unreal/MI_ReinforcedGlass_01a"
{
    Properties
    {
        ...
        [HideInInspector]_CullMode("Float", Float) = 0
        [HideInInspector][ToggleUI]_EnableFogOnTransparent("Boolean", Float) = 1
        [HideInInspector]_CullModeForward("Float", Float) = 0
		...
		Material_Texture2D_0( "TX_Glass_01a_MASK", 2D ) = "white" {}
		Material_Texture2D_1( "CustomAlbedo", 2D ) = "white" {}
		Material_Texture2D_2( "TX_Microdetail_01a_MASK", 2D ) = "white" {}
		Material_TextureCube_0( "Reflection Cubemap", Cube ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_ReinforcedGlass_01a.hlsl"
