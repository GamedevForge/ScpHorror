...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(1.506463,78.600113,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(1.000000,0.852089,0.549186,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,-284.000000,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local20 = (Material.PreshaderBuffer[5].xyz * Local19);
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local22 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 0);
	MaterialFloat3 Local24 = lerp(Local19,Local20,Local22.r);
	...
	MaterialFloat Local28 = (Local26.b * 0.50000000);
	MaterialFloat Local29 = saturate(Local26.r);

	PixelMaterialInputs.EmissiveColor = Local16;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local24;
	PixelMaterialInputs.Metallic = Local26.g;
	PixelMaterialInputs.Specular = Local28;
