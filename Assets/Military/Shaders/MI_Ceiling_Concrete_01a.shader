Shader "Unreal/MI_Ceiling_Concrete_01a"
{
    Properties
    {
		...
		Material_Texture2D_2( "L1 Albedo ", 2D ) = "white" {}
		Material_Texture2D_3( "Detail Base Color", 2D ) = "white" {}
		Material_Texture2D_4( "L1 RMA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Ceiling_Concrete_01a.hlsl"
