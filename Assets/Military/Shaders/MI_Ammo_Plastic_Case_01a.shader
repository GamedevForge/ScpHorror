Shader "Unreal/MI_Ammo_Plastic_Case_01a"
{
    Properties
    {
		...
		Material_Texture2D_2( "Albedo Multi Tint Mask ", 2D ) = "white" {}
		Material_Texture2D_3( "RMA", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Ammo_Plastic_Case_01a.hlsl"
