...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,0.808501,0.696305,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.952855,0.000000,0.000000,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,933546663158002745344.000000,0.000000);//Paint Contrast,Mask Multi,,
