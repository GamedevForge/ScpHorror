...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.750000,1.750000,1.750000,1.022339);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.077000,0.000000,0.000000,0.000000);//(Unknown)
...
void Initialize_MaterialCollection0()
{
	...
	MaterialCollection0.Vectors[1] = float4(289.616547,0.711583,34314351010227998726464633242124288.000000,0.000000);//Paint Contrast,Mask Multi,,
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local14 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 0);
	MaterialFloat Local16 = (Local14.b * 0.50000000);
	MaterialFloat Local17 = PositiveClampedPow(Local14.r,Material.PreshaderBuffer[2].w);
	MaterialFloat Local18 = (Local17 * Material.PreshaderBuffer[3].x);
	...
	PixelMaterialInputs.Metallic = Local14.g;
	PixelMaterialInputs.Specular = Local16;
	PixelMaterialInputs.Roughness = Local19;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local7;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local14.b;
