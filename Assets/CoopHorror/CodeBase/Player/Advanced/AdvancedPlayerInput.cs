...
namespace CoopHorror.CodeBase.Advanced
{
	...
	public sealed class AdvancedPlayerInput : NetworkBehaviour, IBeforeUpdate, IBeforeTick
	{
		...
		public Mouse CurrentMouse {  get; private set; }
		...
		private void ProcessStandaloneInput()
		{
			...
			if (keyboard != null)
			{
				...
				_accumulatedInput.Actions.Set(AdvancedInput.INTERACT_BUTTON, keyboard.eKey.isPressed);
				_accumulatedInput.Actions.Set(AdvancedInput.QUIT_BUTTON, keyboard.qKey.isPressed);
                
				_accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_1, keyboard.digit1Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_2, keyboard.digit2Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_3, keyboard.digit3Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_4, keyboard.digit4Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_5, keyboard.digit5Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_6, keyboard.digit6Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_7, keyboard.digit7Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_8, keyboard.digit8Key.isPressed);
                _accumulatedInput.Actions.Set(AdvancedInput.INVENTORY_SLOT_9, keyboard.digit9Key.isPressed);
				
				_accumulatedInput.Actions.Set(AdvancedInput.MOUSE_LEFT_BUTTON, mouse.leftButton.isPressed);
            }
		}
	}
}
